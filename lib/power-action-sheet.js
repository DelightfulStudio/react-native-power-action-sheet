...
class PowerActionSheet extends Component {
    ...
    open( options = {} ) {
        ...
        const styles = {
            ...createStyles( this.props.styles, options.styles ),
            buttonUnderlayColor: options.buttonUnderlayColor || this.props.buttonUnderlayColor || defaultOptions.buttonUnderlayColor
        };
